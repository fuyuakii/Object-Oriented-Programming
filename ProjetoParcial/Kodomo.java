...
public class Kodomo extends Manga {
    ...
    public void exibirDescricao() {
        ...
        if (educativo != null && !educativo.isEmpty()) {
            System.out.println("Educativo: " + educativo);
        }
        if (fabulaConto != null && !fabulaConto.isEmpty()) {
            System.out.println("Fábula/Conto: " + fabulaConto);
        }
        if (ilustrativo != null && !ilustrativo.isEmpty()) {
            System.out.println("Ilustrativo: " + ilustrativo);
        }
    ...
    public void informacoesEstoque() {
        System.out.println("Kodomo: " + getInformacoesEditoriais().getEditorialBrasileira().getTituloRomanizado()); //Reflexividade
